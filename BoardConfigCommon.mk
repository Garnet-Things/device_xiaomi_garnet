...
BOARD_VENDOR_RAMDISK_KERNEL_MODULES_LOAD := $(strip $(shell cat $(COMMON_PATH)/modules/modules.load))
...
TARGET_PREBUILT_KERNEL := $(GARNET_PREBUILT)/kernel
TARGET_PREBUILT_DTB := $(GARNET_PREBUILT)/dtb.img
BOARD_MKBOOTIMG_ARGS += --dtb $(TARGET_PREBUILT_DTB)
BOARD_INCLUDE_DTB_IN_BOOTIMG := 
BOARD_PREBUILT_DTBOIMAGE := $(GARNET_PREBUILT)/dtbo.img
